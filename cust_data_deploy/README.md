...
The 'cust_data_deploy' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/cust_data_deploy/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] cust_data_deploy_etl` to your workspace.
